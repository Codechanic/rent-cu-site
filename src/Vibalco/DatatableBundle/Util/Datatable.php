...
namespace Vibalco\DatatableBundle\Util;

use Symfony\Component\DependencyInjection\ContainerInterface,
    Symfony\Component\HttpFoundation\Response;
use Doctrine\ORM\Query,
    Doctrine\ORM\Query\Expr\Join;
use Vibalco\DatatableBundle\Util\Factory\Query\DoctrineBuilder,
    Vibalco\DatatableBundle\Util\Formatter\Renderer,
    Vibalco\DatatableBundle\Util\Factory\Prototype\PrototypeBuilder;
...
class Datatable {
    ...
    public function __construct(ContainerInterface $container) {
        ...
        $this->_config = $this->_container->getParameter('vibalco_datatable');
...
//                if(is_bool($val)){
//                    if($value[$k]){
//                        $value[$k] = "<span class='label label-sm label-success'>Enabled</span>";
//                    }else{
//                        $value[$k] = "<span class='label label-sm label-danger'>Dissabled</span>";
//                    }
//                    
//                    $data2[$key] = $value;
//                }
