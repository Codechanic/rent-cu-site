...
namespace Vibalco\DatatableBundle\Twig\Extension;

use Symfony\Component\HttpKernel\KernelInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;
use Vibalco\DatatableBundle\Util\Datatable;

class VibalcoDatatableExtension extends \Twig_Extension {
   ...
   /** @var \Symfony\Component\DependencyInjection\ContainerInterface */
    ...
    public function datatable($options)
    {
        ...
        $main_template            = 'VibalcoDatatableBundle:Main:index.html.twig';
